...
const Navbar = () => {
   return (
      <div className="  bg-base-500">
         <div className="navbar container mx-auto rounded-sm">
            ...
            <div className="navbar-center">
               <a className="btn btn-ghost normal-case text-xl " href="/">World News</a>
            </div>
            <div className="navbar-end">
               ...
               <a href="/login" className="btn  btn-ghost ml-2 ">Login</a>
            </div>
         </div>
      </div>
   );
